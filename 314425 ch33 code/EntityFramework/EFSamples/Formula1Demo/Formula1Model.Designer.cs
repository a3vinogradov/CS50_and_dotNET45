...
namespace Formula1Demo
{
  ...
  public partial class Formula1Entities : ObjectContext
  {
    ...
    public Formula1Entities()
      : base("name=Formula1Entities", "Formula1Entities")
    {
    ...
    /// </summary>
    public Formula1Entities(string connectionString)
      : base(connectionString, "Formula1Entities")
    {
      this.ContextOptions.LazyLoadingEnabled = true;
      OnContextCreated();
    }
    ...
    /// Initialize a new Formula1Entities object.
    /// </summary>
    public Formula1Entities(EntityConnection connection)
      : base(connection, "Formula1Entities")
    {
      this.ContextOptions.LazyLoadingEnabled = true;
      OnContextCreated();
    }
